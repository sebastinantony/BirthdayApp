<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Response.aspx.cs" Inherits="BirthdayApp.Response" %>
...
<body>
		...
		<div class="col-md-12 column">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					 <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1"> <span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button> <a class="navbar-brand" href="#">BirthDay Bumps</a>
				</div>
	...
	<div class="row clearfix">
		<div class="col-md-12 column">
            ...
            <asp:Label ID="lblCode" runat="server" Text="" CssClass="label label-default"></asp:Label>
        ...
        <asp:Label ID="lblAccessToken" runat="server" Text="" CssClass="label label-default"></asp:Label>
	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<div class="row clearfix">
				...
				<div class="col-md-4 column">
					<h3>
						It's complicated - They have found there own pit 
					</h3>
                ...
                <div class="col-md-4 column">
                    <h3>
                        Married - Never look into these list (Danger)
                    </h3>
